...
import {
  Component, ElementRef, EventEmitter, HostListener, Input, NgZone, OnDestroy, OnInit, Optional, Output, Renderer,
  ViewChild
} from "@angular/core"
...
@Component({
  ...
  template: `
    <div class="searchbar-expanding-input-container" [style.width]="_width + 'px'">
      <button ion-button clear icon-only color="dark" class="searchbar-expanding-button disable-hover" type="button"
      ...
      <button ion-button clear class="searchbar-clear-icon" [mode]="_mode" type="button"
