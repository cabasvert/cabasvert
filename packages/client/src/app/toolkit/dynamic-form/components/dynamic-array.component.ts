...
@Component({
  ...
  template: `
    <ng-container [formGroup]="group.control">
      <ion-item-group [formArrayName]="config.name" [class.group-disabled]="disabled$ | async">
...
export class DynamicArrayComponent extends DynamicChildControlComponent<GroupConfig & ComponentConfig> {
}
